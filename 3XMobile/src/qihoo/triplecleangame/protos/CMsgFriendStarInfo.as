package qihoo.triplecleangame.protos {
	...
	public dynamic final class CMsgFriendStarInfo extends com.netease.protobuf.Message {
		public static const QID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("qihoo.triplecleangame.protos.CMsgFriendStarInfo.qid", "qid", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		public static const TOTOALSTAR:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("qihoo.triplecleangame.protos.CMsgFriendStarInfo.totoalStar", "totoalStar", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override public final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (qid$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgFriendStarInfo.qid cannot be set twice.');
					}
					++qid$count;
				...
				case 2:
					if (totoalStar$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgFriendStarInfo.totoalStar cannot be set twice.');
					}
					++totoalStar$count;
