package qihoo.triplecleangame.protos {
	...
	public dynamic final class CMsgAcceptAddPlayerRequest extends com.netease.protobuf.Message {
		public static const USERQID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("qihoo.triplecleangame.protos.CMsgAcceptAddPlayerRequest.userQID", "userQID", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		public static const FRIENDQID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("qihoo.triplecleangame.protos.CMsgAcceptAddPlayerRequest.friendQID", "friendQID", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		public static const ACCEPT:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("qihoo.triplecleangame.protos.CMsgAcceptAddPlayerRequest.accept", "accept", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override public final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (userQID$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgAcceptAddPlayerRequest.userQID cannot be set twice.');
					}
					++userQID$count;
				...
				case 2:
					if (friendQID$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgAcceptAddPlayerRequest.friendQID cannot be set twice.');
					}
					++friendQID$count;
				...
				case 3:
					if (accept$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgAcceptAddPlayerRequest.accept cannot be set twice.');
					}
					++accept$count;
