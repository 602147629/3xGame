package qihoo.triplecleangame.protos {
	...
	public dynamic final class CMsgGetGiftResponse extends com.netease.protobuf.Message {
		public static const USERQID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("qihoo.triplecleangame.protos.CMsgGetGiftResponse.userQID", "userQID", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		public static const FRIENDQID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("qihoo.triplecleangame.protos.CMsgGetGiftResponse.friendQID", "friendQID", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		public static const REQUESTTYPE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("qihoo.triplecleangame.protos.CMsgGetGiftResponse.requestType", "requestType", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		public static const ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("qihoo.triplecleangame.protos.CMsgGetGiftResponse.id", "id", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		public static const REQUESTNUM:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("qihoo.triplecleangame.protos.CMsgGetGiftResponse.requestNum", "requestNum", (5 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		public static const RESULT:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("qihoo.triplecleangame.protos.CMsgGetGiftResponse.result", "result", (6 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override public final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (userQID$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgGetGiftResponse.userQID cannot be set twice.');
					}
					++userQID$count;
				...
				case 2:
					if (friendQID$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgGetGiftResponse.friendQID cannot be set twice.');
					}
					++friendQID$count;
				...
				case 3:
					if (requestType$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgGetGiftResponse.requestType cannot be set twice.');
					}
					++requestType$count;
				...
				case 4:
					if (id$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgGetGiftResponse.id cannot be set twice.');
					}
					++id$count;
				...
				case 5:
					if (requestNum$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgGetGiftResponse.requestNum cannot be set twice.');
					}
					++requestNum$count;
				...
				case 6:
					if (result$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgGetGiftResponse.result cannot be set twice.');
					}
					++result$count;
