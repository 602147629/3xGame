package qihoo.triplecleangame.protos {
	...
	public dynamic final class CMsgStartMatchRequest extends com.netease.protobuf.Message {
		public static const MATCHID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("qihoo.triplecleangame.protos.CMsgStartMatchRequest.matchID", "matchID", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override public final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (matchID$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgStartMatchRequest.matchID cannot be set twice.');
					}
					++matchID$count;
